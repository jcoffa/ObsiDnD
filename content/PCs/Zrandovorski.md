...
>
> You start at level 1 with 4 spells prepared. Most levels increase this limit by +1, except for a few specific levels which change the limit differently:
> - Level 5 (+2, total 9)
> - Level 9 (+2, total 14)
> - Level 12 (+0, total 16)
> - Level 16 (+2, total 21)

> [!info]- Spell Table Column Key
>
> **Prep:**
>
...
> - `R` = Can be cast as a Ritual (spell doesn't need to be prepared since I'm a Wizard)
> - `V` = Verbal casting component
> - `S` = Somatic casting component
> - `M` = Material casting component (**Notes** column will contain the material if it has a GP cost or is consumed)
>
> **Notes** is a miscellaneous column to put any info not covered elsewhere, such as notable Material components or if the spell can be cast for free.
>
> **Source** is for tracking where spells were learned from. Spells learned from the normal "learn 2 spells after gaining a Wizard level" do not have a source.
>
