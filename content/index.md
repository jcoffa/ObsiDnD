...
This wiki may be exported and hosted elsewhere, so it may be important to know that this is written as an [Obsidian Vault](https://obsidian.md/).
...
- Templater, for templating that is far more powerful than Obsidian's builtin

### Creating Notes

Try to leverage the Quick Add commands to create notes, e.g. "New Session Log". This will automatically apply the proper templates and place the note in the correct folder.
